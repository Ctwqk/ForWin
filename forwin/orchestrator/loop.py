...
from forwin.orchestrator.repair_coordinator import ChapterRepairCoordinator
...
class WritingOrchestrator:
    ...
    def __init__(
        ...
        self.repair_coordinator = ChapterRepairCoordinator(self)
    ...
    def _review_and_maybe_rewrite(
        ...
        *,
        ...
        return self.repair_coordinator.review_and_maybe_rewrite(
            session=session,
            repo=repo,
            updater=updater,
            checker=checker,
