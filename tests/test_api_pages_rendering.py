...
class ApiPagesRenderingTests(unittest.TestCase):
    ...
    def test_home_page_uses_incremental_drawer_refresh_and_hides_raw_planned_label(
        ...
        self.assertIn("forwin-tab-change", html)
        ...
        self.assertIn("nav.book", html)
        self.assertIn("nav.task", html)
        self.assertIn("nav.config", html)
        ...
        self.assertIn('nav.className = "nav-tabs nav-tabs--primary"', html)
        ...
        self.assertNotIn("Scenario Rehearsal", html)
        self.assertNotIn("Provisional Preview", html)
        ...
        self.assertIn("review_modal_shell", html)
        self.assertIn("review_layer_flow", html)
        self.assertIn("REVIEW_LAYER_ORDER", html)
        self.assertIn("openReviewModal", html)
        self.assertIn("decision_layers", html)
        self.assertNotIn("review_engine_decision", html)
    ...
    def test_publishers_page_renders_javascript_that_passes_node_syntax_check(
        ...
        self.assertIn('aria-label", "ForWin primary navigation"', html)
        self.assertIn('<forwin-topbar active="publish"></forwin-topbar>', html)
        self.assertIn("FORWIN_TOPBAR_ITEMS", html)
        self.assertIn('customElements.define("forwin-topbar"', html)
        self.assertIn("scrollbar-gutter: stable", html)
        self.assertIn('group.className = "lang-toggle"', html)
        ...
        self.assertIn("forwin-lang", html)
        self.assertIn("window.setLang", html)
        self.assertIn("nav.publish", html)
        self.assertIn("Books", html)
        self.assertIn("Tasks", html)
        self.assertIn("Archive", html)
        self.assertIn("Publish", html)
