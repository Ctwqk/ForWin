...
from forwin.genesis.constants import GENESIS_STAGE_ORDER, _STAGE_TO_SECTION
from forwin.genesis.fallbacks import _fallback_blueprint, _fallback_world
            ...
            "prompt_traces": [
                {
                    ...
                    "prompt_layers": _json_load_list_dicts(row.prompt_layers_json),
