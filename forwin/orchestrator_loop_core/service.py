...
from forwin.orchestrator_loop_core.world_projection import _prompt_trace_success_summary, _run_phase3_pass
...
WritingOrchestrator._register_writer_output_entities = _register_writer_output_entities
