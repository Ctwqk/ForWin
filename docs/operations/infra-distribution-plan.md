...
> 状态时间戳：2026-05-29
> 目标：应用层迁出 150，基础设施层 / GPU / 浏览器账户单点留在 150，ForWin 和 VideoProcess 的主要代码入口保留在 246。
...
| `10.0.0.246` `ccttww-rog` | Development node | ForWin 源码修改入口：`/home/kikuhiko/ForWin`；VideoProcess 源码修改入口：`/home/kikuhiko/videoprocess` |
...
| 类型 | 位置 | 说明 |
| --- | --- | --- |
| 源码入口 | `10.0.0.246:/home/kikuhiko/ForWin` | 建 Codex project、改 ForWin 代码、改 ForWin 数据库模型/迁移/业务逻辑都从这里开始 |
...
| Swarm 服务 | `forwin-app-swarm`、`forwin-mcp-swarm` | 由 150 Swarm manager 管理 |
...
| --- | --- |
| ForWin | `10.0.0.246:/home/kikuhiko/ForWin` |
| VideoProcess | 优先 `10.0.0.246:/home/kikuhiko/videoprocess`；也可用 `10.0.0.126:/Users/magi1/VideoProcess-app` 或 `10.0.0.150:/home/taiwei/Constructure-repos/videoprocess` |
