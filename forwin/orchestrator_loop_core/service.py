...
from forwin.orchestrator_loop_core.governance import _project_governance, _record_decision_event, _audit_current_plan_before_write, _audit_future_plans_after_acceptance, _future_plan_audit_plans, _future_plan_audit_band_rows, _record_future_plan_audit_events, _record_generation_audit_checkpoint_if_due, _generation_audit_checkpoint_payload, _previous_band_row, _manual_boundary_checkpoint, _strict_progression_block, _create_auto_band_checkpoint, _filter_supported_state_changes
...
WritingOrchestrator._run_obligation_prompt_json_gate = _run_obligation_prompt_json_gate
