...
def register_api_routes(
    ...
    *,
    ...
    route_definitions = [
        ...
        ("/api/publishers/extension-package/firefox", ["GET"], handlers["download_publisher_firefox_extension_package"], {}),
        ...
        ("/api/publishers/work-bindings", ["GET"], handlers["list_publisher_work_bindings"], {"response_model": list[PublisherWorkBindingResponse]}),
        ("/api/publishers/chapter-bindings", ["GET"], handlers["list_publisher_chapter_bindings"], {"response_model": list[PublisherChapterBindingResponse]}),
        ("/api/publishers/covers", ["GET"], handlers["list_publisher_cover_assets"], {"response_model": list[PublisherCoverAssetResponse]}),
        ("/api/publishers/covers/generate", ["POST"], handlers["generate_publisher_cover_candidates"], {"response_model": dict[str, Any]}),
        ("/api/publishers/covers/select", ["POST"], handlers["select_publisher_cover_asset"], {"response_model": PublisherCoverAssetResponse}),
        ("/api/publishers/covers/approve", ["POST"], handlers["approve_publisher_cover_asset"], {"response_model": PublisherCoverAssetResponse}),
        ("/api/publishers/covers/reject", ["POST"], handlers["reject_publisher_cover_asset"], {"response_model": PublisherCoverAssetResponse}),
        ("/api/publishers/covers/upload", ["POST"], handlers["enqueue_publisher_cover_upload"], {"response_model": PublisherUploadJobResponse}),
        ("/api/publishers/audit-sync", ["POST"], handlers["enqueue_publisher_audit_sync"], {"response_model": PublisherUploadJobResponse}),
        ("/api/publishers/preflight", ["POST"], handlers["publisher_preflight"], {"response_model": PublisherPreflightResponse}),
        ("/api/publishers/login-qr-one-shot", ["POST"], handlers["start_publisher_login_qr_one_shot"], {"response_model": PublisherLoginQrOneShotResponse}),
        ...
        ("/api/publishers/extension/login-qr", ["POST"], handlers["publisher_extension_login_qr_notify"], {"response_model": ExtensionLoginQrNotifyResponse}),
        ...
        ("/api/projects/{project_id}/projections/refresh", ["POST"], handlers["refresh_projection"], {}),
        ("/api/projects/{project_id}/projections/status", ["GET"], handlers["get_projection_status"], {}),
        ("/api/projects/{project_id}/projections/pages", ["GET"], handlers["list_projection_pages"], {}),
        ("/api/projects/{project_id}/projections/pages/{page_key}", ["GET"], handlers["get_projection_page"], {}),
        ...
        ("/api/projects/{project_id}/chapters/page", ["GET"], handlers["list_chapter_page"], {"response_model": ChapterListResponse}),
