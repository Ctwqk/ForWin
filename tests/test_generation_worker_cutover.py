...
def test_api_split_keeps_only_run_alias_compatibility() -> None:
    assert not hasattr(api_module, "_build_runtime_config")
    assert not hasattr(api_module, "_build_saved_runtime_config")
    assert api_module._run_generation_with_config is api_module.run_generation_with_config
    assert api_module._run_continue_project_with_config is api_module.run_continue_project_with_config
