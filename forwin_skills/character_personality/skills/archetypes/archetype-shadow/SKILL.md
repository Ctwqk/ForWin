---
name: archetype-shadow
chinese_name: 阴影
description: 具象化角色压抑欲望、羞耻、攻击性或堕落可能的叙事功能原型。
forwin_scope: character_personality
category: character_personality_skill
skill_type: archetype
version: "1.0"
status: draft
...
tags:
  ...
  - placeholder
---
# Skill: archetype-shadow

## Core Function

TBD: 具象化角色压抑欲望、羞耻、攻击性或堕落可能的叙事功能原型。
...
```yaml
archetype_specific:
  narrative_function: TBD
  story_promise: TBD
  default_conflict_role: TBD
  positive_function: TBD
  negative_function: TBD
  relation_to_protagonist: TBD
```
