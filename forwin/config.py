...
def _env_values() -> dict[str, object]:
    env = _resolved_env()
    return {
        "db_path": _env_str(env, "FORWIN_DB_PATH", "data/novel.db"),
        ...
        "retrieval_backend": _env_str(env, "FORWIN_RETRIEVAL_BACKEND", "local"),
        "retrieval_root": _env_str(env, "FORWIN_RETRIEVAL_ROOT", "data/retrieval"),
        "qdrant_url": _env_str(env, "FORWIN_QDRANT_URL"),
