...
class ApiPagesRenderingTests(unittest.TestCase):
    ...
    def test_home_page_uses_incremental_drawer_refresh_and_hides_raw_planned_label(self) -> None:
        ...
        self.assertIn("<h1>工作台</h1>", html)
        self.assertIn("<h2>书本</h2>", html)
        self.assertIn("<h2>任务</h2>", html)
        self.assertIn("<h2>模型</h2>", html)
        self.assertIn("<h2>生成默认值</h2>", html)
        self.assertIn("<h2>平台</h2>", html)
    ...
    def test_publishers_page_renders_javascript_that_passes_node_syntax_check(self) -> None:
        ...
        self.assertIn("<h1>发布</h1>", html)
        self.assertIn("<h2>扩展</h2>", html)
        self.assertIn("<h2 style=\"margin-top:0;\">上传</h2>", html)
        self.assertIn("<h2 style=\"margin-top:0;\">最近任务</h2>", html)
