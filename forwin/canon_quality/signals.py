...
class SignalKind(StrEnum):
    ...
    closed_thread_reopened = "closed_thread_reopened"
    dead_character_resurrection = "dead_character_resurrection"
    impossible_location_teleport = "impossible_location_teleport"
    level_rollback = "level_rollback"
    power_level_rollback = "power_level_rollback"
    duplicate_artifact = "duplicate_artifact"
    duplicate_resource = "duplicate_resource"
    duplicate_artifact_resource = "duplicate_artifact_resource"
    ...
    appellation_referent_conflict = "appellation_referent_conflict"
    internal_key_leakage_v2 = "internal_key_leakage_v2"
    protagonist_name_missing = "protagonist_name_missing"
    protagonist_name_diluted = "protagonist_name_diluted"
    chapter_title_mismatch = "chapter_title_mismatch"
    chapter_summary_empty = "chapter_summary_empty"
