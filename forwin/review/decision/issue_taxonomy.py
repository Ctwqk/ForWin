...
ISSUE_TO_SCOPE: dict[str, IssueScope] = {
    ...
    "appellation_referent_conflict": "draft",
    "internal_key_leakage_v2": "draft",
    "protagonist_name_missing": "draft",
    "protagonist_name_diluted": "draft",
    "chapter_title_mismatch": "draft",
    "chapter_summary_empty": "draft",
    ...
    "entity_admission_plan_conflict": "operator",
    "entity_admission_plan_invalid": "operator",
    "single_chapter_pacing": "chapter_plan",
    "single_chapter_callback": "chapter_plan",
    "motivation_gap": "chapter_plan",
    "transition_bridge_needed": "chapter_plan",
    "foreshadowing_payoff": "chapter_plan",
    ...
    "reader_promise_payoff": "band_plan",
    "reveal_escalation_needed": "band_plan",
    "style_repetition_pressure": "band_plan",
    ...
    "form_countdown_inconsistency": "chapter_plan",
    "form_invariant_drift": "chapter_plan",
